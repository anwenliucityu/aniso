...
'''
    ...
    Al dislocation type for bcc metal:
        --- screw <111>            [40,70,1], 3500atoms
'''
element_struct      =   'hcp'
dislocation_type    =   'screw_ca_pyrII'
partial_dislocation =   True
partial_split_dis   =   6
...
'''
start_temperature   =   0#[1200,1300,1400,1500,1600]#[500,600,700,800,900,1000,1100,1200]
